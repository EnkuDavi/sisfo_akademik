...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-9 mx-auto">
          <h1 class="mb-5">Selamat Datang di SMK PGRI 4 Karawang</h1>
        </div>
  ...
  <!-- Icons Grid -->
  <section class="features-icons bg-light text-center" id="galeri">
    <div class="container">
      <div class="row">
        <div class="col-lg-4">
  ...
  <section class="showcase">
    <div class="container-fluid p-0">
      ...
      <div class="row no-gutters">
        <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('<?php echo base_url() ;?>assets/landing/img/bg-showcase-3.jpg');"></div>
        <div class="col-lg-6 order-lg-1 my-auto showcase-text">
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="testimonial-item mx-auto mb-5 mb-lg-0">
            <img class="img-fluid rounded-circle mb-3" src="<?php echo base_url() ;?>assets/landing/img/testimonials-1.jpg" alt="">
            <h5>Margaret E.</h5>
        ...
        <div class="col-lg-4">
          <div class="testimonial-item mx-auto mb-5 mb-lg-0">
            <img class="img-fluid rounded-circle mb-3" src="<?php echo base_url() ;?>assets/landing/img/testimonials-2.jpg" alt="">
            <h5>Fred S.</h5>
        ...
        <div class="col-lg-4">
          <div class="testimonial-item mx-auto mb-5 mb-lg-0">
            <img class="img-fluid rounded-circle mb-3" src="<?php echo base_url() ;?>assets/landing/img/testimonials-3.jpg" alt="">
            <h5>Sarah W.</h5>
